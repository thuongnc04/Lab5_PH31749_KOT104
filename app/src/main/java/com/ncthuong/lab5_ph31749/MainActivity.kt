package com.ncthuong.lab5_ph31749
...
import com.ncthuong.lab5_ph31749.ui.theme.Lab5_PH31749Theme
...
//private var isCheckedRememberUsernamePass = false
...
fun LoginScreen(navController: NavHostController) {
    ...
    var isCheckedRememberUsernamePass by remember {
...
// Username TextField
        ...
        RememberMeSwitch (isCheckedRememberUsernamePass) { isCheckedRememberUsernamePass = !isCheckedRememberUsernamePass }
        Spacer(modifier = Modifier.height(12.dp))
        Button(
            onClick = {
                if (username.isNotBlank() && password.isNotBlank()) {

                    if (isCheckedRememberUsernamePass) {
                        Toast.makeText(
...
@Composable
fun RememberMeSwitch(isCheck: Boolean, onCheckChanged: (Boolean) -> Unit) {
